#NAME : editExcelFile.py
#Author : Almeris15
#Description :
# Script pour l'edition de fichier Excel
# openpyxl nécessaire pour l'utilisation su script
#  
# Changelog:
...
dirExcel = dir + "\\..\\EXCEL_FILES" # Emplacement de la racine du programme
InputFile = sys.argv[1] + "_" + datetime.datetime.now().strftime("%Y%m%d") + ".xlsx"
